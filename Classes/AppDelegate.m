...
#import "FeedMasterViewController_iPhone.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        ...
        FeedMasterViewController_iPhone *fmvc = [[[FeedMasterViewController_iPhone alloc] initWithNibName:@"FeedMasterViewController_iPhone" bundle:nil] autorelease];
        UINavigationController *navController = [[[UINavigationController alloc] initWithRootViewController:fmvc] autorelease];
